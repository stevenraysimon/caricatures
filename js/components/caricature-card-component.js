class CaricatureCard extends HTMLElement {
    ...
    connectedCallback() {
        ...
        // Only use lazy loading for non-priority images (below the fold)
        ...
        <div class="caricature">
          <picture>
            ...
            <img src="${jpgSrc}" alt="${name}" title="${name}" width="400" height="450" ${loadingAttr} style="max-width: 100%; height: auto;">
          </picture>
          <p class="text">${name}</p>
        </div>
      `;
